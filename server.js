...
if (MODE == 'CLUSTER' && cluster.isMaster) {
    ...
    app.get('/login', (req, res) => {
        ...
        logger.info(`Ruta ${req.path} metodo GET`)
    ...
    app.get('*', (req, res) => {
        ...
        logger.warn(`Ruta ${req.method} ${req.path} no esta implementada`)

        logger.error(`Ruta ${req.method} ${req.path} no esta implementada`)
